...
Buffer.Integer.IntegerStart(builder)
Buffer.Integer.IntegerAddValue(builder,10)

integer = Buffer.Integer.IntegerEnd(builder)
...
integer = Buffer.Integer.Integer.GetRootAsInteger(buf, 0)
