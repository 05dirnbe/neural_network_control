...
def main(args, context):
	...
	logger.info("Starting fake data stream. Sending %d elements.", args.n)
	...
	try:
		...
		for i in xrange(args.n):
			...
			input_data.send("Fake data packet %s" % message)
			time.sleep(args.s)
		
		logger.info("Fake data transfer complete.")
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(prog="fake_camera_data", description='Generates fake camera data.')
