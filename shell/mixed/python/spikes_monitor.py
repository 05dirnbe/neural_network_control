...
def main(args, context):
	...
	output_data.setsockopt(zmq.SUBSCRIBE,settings.topics["spikes"])
	...
	try:
		...
		while True:
			...
			message = serializer.read_buffer(message_buffer, topic = "spikes")
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(prog="spikes_monitor", description='Monitors the output of the controller regarding neuron spikes.')
